        ...
        <section className="container">
            ...
            <form class="justify-content-center" id="contact-form">
                ...
                <div class="mt-5">
                    ...
                    <input type="text" name="email" class="form-control" defaultValue={email} onBlur={handleChange} />
                </div>
                <div class="mt-5">
                    <label htmlFor="message">Message:</label>
                    <textarea name="message" class="form-control" defaultValue={message} onBlur={handleChange} />
                </div>
                {errorMessage && (
                    <div>
